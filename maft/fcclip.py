...
class FCCLIP(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.ranking = nn.SmoothL1Loss()  # BCELoss BCEWithLogitsLoss SmoothL1Loss
    ...
    def _freeze(self, ):
        for name, param in self.named_parameters():
            if 'backbone_t' in name or 'backbone' in name:
    ...
    def prepare_class_names_from_metadata(self, metadata, train_metadata):
        ...
        # print(num_templates, class_names)
        # num_templates['xx']
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            # print('in_vocab_cls_results', in_vocab_cls_results.shape, 'out_vocab_cls_results', out_vocab_cls_results.shape, self.category_overlapping_mask.shape)
